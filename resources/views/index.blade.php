...
@section('content')
    <div class="container mx-auto px-4 pt-16">
        <div class="filmes-populares">
            <h2 class="uppercase tracking-wider text-yellow-500 text-lg font-semibold">Filmes Populares</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 ">
                <div class="mt-8">
                    <a href="#">
                        <img class="hover:opacity-75 transition-ease-in-out duration-150" src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcS1nI_Z3FYp-mE3L83VBWb60wJpbzFcK2we7_ZeV0W0yLgjE-x3" alt="Velozes e Furiosos">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-purple-300">Velozes e Furiosos 9</a>
                        <div class="flex items-center text-purple-400 mt-1 text-sm">
